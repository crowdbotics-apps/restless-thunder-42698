"""
Django settings for restless_thunder_42698 project.
...
ROOT_URLCONF = 'restless_thunder_42698.urls'
...
WSGI_APPLICATION = 'restless_thunder_42698.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_thunder_42698 API",
    "DESCRIPTION": "API documentation for restless_thunder_42698 App",
    "VERSION": "v1",
}
